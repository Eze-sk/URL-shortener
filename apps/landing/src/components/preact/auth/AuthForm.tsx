  ...
  return (
    ...
    >
      ...
      <span className="
        ...
        group-hover:text-light-annotation group-hover:dark:text-dark-annotation"
      >
        {message}
      </span>
    </button>
...
function PasswordInput({ error }: { error: string | null | undefined }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <label htmlFor="password" className="text-light-general dark:text-dark-general">Password:</label>
      <div className="relative flex items-center">
        ...
        />
        <button
          className="absolute right-2 transition-all duration-300 group"
          onClick={handleShow}
        ...
        >
          {
            show ? (
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 16 16"
                className="text-light-general dark:text-dark-general group-hover:text-light-annotation group-hover:dark:text-dark-annotation"
              >
